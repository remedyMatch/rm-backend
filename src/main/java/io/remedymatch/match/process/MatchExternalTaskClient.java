...
public class MatchExternalTaskClient {
    ...
    public void doSubscribe() {
        ...
        client.subscribe("angebot_anfrage_match_anlegen_topic").lockDuration(2000).handler((externalTask, externalTaskService) -> {
            try {
        ...
        client.subscribe("bedarf_anfrage_match_anlegen_topic").lockDuration(2000).handler((externalTask, externalTaskService) -> {
            try {
