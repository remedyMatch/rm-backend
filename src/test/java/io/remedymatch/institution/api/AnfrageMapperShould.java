...
public class AnfrageMapperShould {
	...
	private static final InstitutionDTO INSTITUTION_AN_DTO = InstitutionDTO.builder().id(INSTITUTION_AN_ID.getValue()).build();
	...
	private static final InstitutionStandortDTO STANDORT_AN_DTO = InstitutionStandortDTO.builder().id(STANDORT_AN_ID.getValue()).build();
	...
	private static final InstitutionDTO INSTITUTION_VON_DTO = InstitutionDTO.builder().id(INSTITUTION_VON_ID.getValue()).build();
	...
	private static final InstitutionStandortDTO STANDORT_VON_DTO = InstitutionStandortDTO.builder().id(STANDORT_VON_ID.getValue()).build();
