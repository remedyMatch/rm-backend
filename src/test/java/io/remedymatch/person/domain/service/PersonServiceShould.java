...
class PersonServiceShould {
    ...
    void neue_Person_anlegen() {
        ...
        val institutionStandort = institution.getStandorte().get(0);
        val institutionStandortEntity = institutionEntity.getStandorte().get(0);
    ...
    void ein_anderes_Standort_als_aktuelles_Standort_der_Person_aendern() {
        ...
        PersonStandortEntity anderesStandort = PersonStandortEntity.builder() //
                ...
                .standort(andereInstitutionEntity.getStandorte().get(0))//
                .oeffentlich(true)//
                .build();
        ...
        val neuesAktuellesStandort = PersonStandort.builder() //
                ...
                .standort(andereInstitution.getStandorte().get(0))//
                .oeffentlich(true)//
                .build();
