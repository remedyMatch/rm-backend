...
public class AnfrageMapper {
    ...
    public static AnfrageDTO mapToDTO(AngebotAnfrage angebotAnfrage) {
        return AnfrageDTO.builder()
                ...
                .institutionAn(InstitutionMapper.mapToDTO(angebotAnfrage.getAngebot().getInstitution()))
                ...
                .standortAn(InstitutionStandortMapper.mapToDTO(angebotAnfrage.getAngebot().getStandort()))
