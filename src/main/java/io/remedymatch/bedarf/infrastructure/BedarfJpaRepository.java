...
public interface BedarfJpaRepository extends JpaRepository<BedarfEntity, UUID> {
    ...
    List<FilterEntry> countAllBedarfKategorienByDeletedFalseAndBedientFalse(@Param("institutionId") UUID institutionId);
    ...
    List<FilterEntry> countAllBedarfArtikelByDeletedFalseAndBedientFalseAndArtikel_ArtikelKategorie(
    ...
    List<FilterEntry> countAllBedarfArtikelVariantenByDeletedFalseAndBedientFalseAndArtikel_Id(
