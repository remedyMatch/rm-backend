...
public class BedarfAnlageService {
    ...
    public Bedarf neuenBedarfEinstellen(final @NotNull @Valid NeuerBedarf neuerBedarf) {
        ...
        val bedarf = mitEntfernung(bedarfRepository.save(BedarfEntity.builder() //
        ...
        bedarfProzessService.prozessStarten(bedarf.getId(), userService.getContextUserId(),
                bedarf.getInstitution().getId());
