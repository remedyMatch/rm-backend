...
public class DatabaseInitializer implements ApplicationListener<ContextRefreshedEvent>
{
	...
	private AngebotEntity createAngebot(String kommentar, String standort, boolean medizinisch, boolean steril, boolean originalverpackt, double anzahl, LocalDateTime haltbarkeit, ArtikelEntity artikel, InstitutionEntity institution)
	{
	...
	{		
		...
		createInstitution("institution9", "Charitee - Universitätsmedizin Berlin", InstitutionTyp.HOSPITAL);		
		...
		createInstitution("institution12", "Wilhelmsburger Krankenhaus Groö-Sand", InstitutionTyp.HOSPITAL);		
		createInstitution("institution13", "Universitätsklinikum Hamburg-Eppendorf", InstitutionTyp.HOSPITAL);		
