...
@Tag("InMemory")
@Tag("SpringBoot")
public class AngebotSchliessenSchould extends AngebotControllerTestBasis {
    ...
    public void angebot_schliessen() throws Exception {
...
//		          .body("rest")
        ...
        MockMvcBuilders.webAppContextSetup(webApplicationContext).build().perform(MockMvcRequestBuilders //
                .post("/angebot/" + angebotId.getValue() + "/schliessen") //
